...
public class CreateAccount {
    ...
    public CreateAccount() {
        ...
        login.setForeground(Color.decode("#7CB342"));
        login.setBackground(Color.white);
        create.setForeground(Color.decode("#7CB342"));
        ...
        lblNameM.setBounds(600, 125, 250, 30);
        lblEmailM.setBounds(600, 175, 250, 30);
        lblPhoneM.setBounds(600, 225, 250, 30);
        lblBirthdayM.setBounds(600, 275, 250, 30);
        lblAddressM.setBounds(600, 375, 250, 30);
        lblIdentifyCardM.setBounds(600, 425, 250, 30);
    ...
    class Create implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (((day.getSelectedItem().toString()).equals("Day") == true) || ((month.getSelectedItem().toString()).equals("Month") == true) || ((year.getSelectedItem().toString()).equals("Year") == true)) {
                ...
                lblBirthdayM.setText("Choice birthday");
            }
            ...
            if (acc == null) {
                ...
                if (errors.size() == 0) {
                    ...
                    if (((lAccount >= 6) == false) && (((lAccount > 0) == true))) {
                        lblAccountM.setForeground(Color.red);
                        lblAccountM.setText("Account too short");
                    }
                    if (((lPassword >= 6) == false) && ((lPassword > 0) == true)) {
    ...
    private void showError(HashMap<String, String> errors) {
        ...
        if (errors.containsKey("txtName")) {
            lblNameM.setForeground(Color.RED);
        ...
        if (errors.containsKey("txtAddress")) {
            lblAddressM.setForeground(Color.RED);
        ...
        if (errors.containsKey("txtIdentifyCard")) {
            lblIdentifyCardM.setForeground(Color.RED);
