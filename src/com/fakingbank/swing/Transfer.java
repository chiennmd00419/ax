...
public class Transfer {
    ...
    public Transfer(String account) {
        ...
        lblTransferM.setBounds(250, 280, 250, 30);
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            try {
               // Account a = model.Number(txtNumber1.getText());
                ...
                Account d = model.getAccount(txtNumber1.getText());
                ...
                if (d == null) {
                    ...
                    lblNumber1M.setText("Incorrect account");
                }

                if ((d != null) && (c >= 50000) && (Long.valueOf(txtTransfer.getText()) > 0 == true)) {
                    //long qqq = Long.valueOf(txtTransfer.getText());
                    model.transfer(Long.valueOf(txtTransfer.getText()), txtNumber.getText(), d.getNumber());
