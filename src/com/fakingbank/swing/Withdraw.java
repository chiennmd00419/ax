...
public class Withdraw {
    ...
    class Withdraws implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            try {
                Account account = model.Number(txtNumber.getText());
                long surplus = account.getBalance() - Long.valueOf(txtWithdraw.getText());        
                if ((surplus >= 50000)&& (Long.valueOf(txtWithdraw.getText())>0 ==true )) {
